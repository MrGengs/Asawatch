 ...
 * (ppg.h) dan offsetnya baru berguna untuk pengujian lab per-unit sekarang,
 * bukan alur pengguna akhir. Kalau nanti dibutuhkan dari app, jalurnya sama
 * seperti SET_KALIBRASI tensi: opcode baru + update dokumen + versi. */
bool    aw_kalibrasi_glukosa_ada(void);
 ...
 * dari nol: perhitungan saat dicas (dikoreksi tegangan charger, langsung dari
 * tegangan begitu plateau) dan perhitungan saat boot di baterai (kurva tegangan)
 * dua hal berbeda dan bisa selisih beberapa persen -- cukup untuk membuat satu
 * bar hilang seketika tepat saat jam dinyalakan ulang. 0 = belum pernah
 * disimpan. */

 ...
 * Size: 46 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --size 46 --font /home/mrgengs/Arduino/libraries/lvgl/scripts/built_in_font/Montserrat-Medium.ttf -r 0x2D,0x30-0x39 --format lvgl -o font_digits_46.c --force-fast-kern-format
 ******************************************************************************/

#include <lvgl.h>

#ifndef FONT_DIGITS_46
#define FONT_DIGITS_46 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 282, .box_w = 13, .box_h = 4, .ofs_x = 2, .ofs_y = 11},
    {.bitmap_index = 26, .adv_w = 491, .box_w = 27, .box_h = 33, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 472, .adv_w = 272, .box_w = 13, .box_h = 33, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 687, .adv_w = 422, .box_w = 25, .box_h = 33, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1100, .adv_w = 421, .box_w = 25, .box_h = 33, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1513, .adv_w = 492, .box_w = 30, .box_h = 33, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2008, .adv_w = 422, .box_w = 25, .box_h = 33, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2421, .adv_w = 454, .box_w = 26, .box_h = 33, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2850, .adv_w = 440, .box_w = 25, .box_h = 33, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3263, .adv_w = 474, .box_w = 26, .box_h = 33, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3692, .adv_w = 454, .box_w = 26, .box_h = 33, .ofs_x = 1, .ofs_y = 0}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_digits_46 = {
#else
lv_font_t font_digits_46 = {
#endif

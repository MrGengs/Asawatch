 ...
 *     ia akan menaikkan bus jadi 400 kHz. Board ini dipertahankan konservatif
 *     di 100 kHz (lihat catatan Wire.setClock() di touch.ino), jadi begin()
 *     TIDAK boleh dipanggil dengan I2C_SPEED_FAST.
 *
 ...
 *
 * Semua fungsi dipanggil dari konteks loop() -- sama seperti RTC,

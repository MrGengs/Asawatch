/*
 * PCF85063 (RTC on-board ESP32-C6-LCD-1.69, I2C 0x51).
 *
 * PENTING soal bus I2C: RTC berbagi bus dengan PPG (MAX30105/30102). Karena
 * itu SEMUA fungsi di file ini hanya boleh dipanggil dari konteks loop()/timer
 * LVGL, thread yang sama dengan ppg_update(). Jangan dipanggil dari task
 * jaringan, supaya tidak ada dua transaksi I2C yang saling menyela.
 */
#pragma once

...
halaman utama (build_home() di no_touch.ino), gradasi ungu->sian, tata letak
...
GRAD_BAWAH = (70, 210, 220)    # sian, dekat y=280 -- HARUS sama dgn no_touch.ino
CANVAS_H = 280                 # HARUS sama dengan SCREEN_H di no_touch.ino
BG = (0, 0, 0)                  # HARUS sama dengan C_HOME_BG di no_touch.ino
...
ROW_H = 112          # tinggi akhir tiap digit di layar -- HARUS sama dengan
                     # HOME_ROW_H di no_touch.ino
COL_W = 75           # HARUS sama dengan HOME_COL_W di no_touch.ino (lebar kolom,
                     # digit dipusatkan horizontal di dalamnya)

CHARS = "0123456789"
OUT = "/home/harjo/Documents/no_touch/home_digits.h"
...
if __name__ == "__main__":
    ...
    # di no_touch.ino) -- tapi warnanya sudah dibakar per posisi Y, jadi setiap
    ...
    with open(OUT, "w") as f:
        f.write("/* Dibuat otomatis oleh genhomedigits.py -- jangan diedit manual,\n"
                ...
                "   horizontal -- build_home() di no_touch.ino cuma menempel bitmap ini\n"

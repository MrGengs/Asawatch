...
3. LATAR DIPANGGANG, bukan alfa.
   ...
   rata (SPL_BG di touchscreen.ino), jadi latar itu bisa ikut dipanggang ke dalam
   ...
   SPL_BG di touchscreen.ino harus sama persis dengan BG di bawah.
"""
import colorsys

from PIL import Image

SRC = "/home/harjo/Documents/touchscreen/images/IMG-20260821-WA0004.jpg"
OUT = "/home/harjo/Documents/touchscreen/splash_assets.h"

# Harus identik dengan SPL_BG di touchscreen.ino. Lihat langkah 3 di atas.
BG = (0x09, 0x0A, 0x10)
...
if __name__ == "__main__":
    ...
    with open(OUT, "w") as f:
        f.write("/* Dibuat otomatis oleh gensplash.py dari IMG-20260821-WA0004.jpg.\n"
                ...
                "   persis dengan SPL_BG di touchscreen.ino, kalau tidak kotak gambarnya\n"
